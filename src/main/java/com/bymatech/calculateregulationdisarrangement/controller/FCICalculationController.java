...
public class FCICalculationController {
    ...
    @GetMapping(path="/calculate-bias/fci/{symbol}/position/{id}/percentages/species-relative-to-position/refresh/{refresh}", consumes="application/json", produces="application/json")
    ...
    @GetMapping(path="/calculate-bias/fci/{symbol}/position/{id}/valued/specie-relative-to-position/refresh/{refresh}", consumes="application/json", produces="application/json")
    ...
    @GetMapping(path="/calculate-bias/fci/{symbol}/position/{id}/percentages/specie-relative-to-specie-type/refresh/{refresh}", consumes="application/json", produces="application/json")
